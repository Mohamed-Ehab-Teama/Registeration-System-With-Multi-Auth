...
<form class="col-lg-3 col-md-4 col-10 mx-auto text-center">
    ...
    <div class="form-group">
        ...
        <input type="password" id="pass" class="form-control form-control-lg" placeholder="Password" required="" autofocus="">
    </div>

    <div class="form-group">
        <label for="confirm-pass" class="sr-only">Confirm Password</label>
        <input type="password" id="confirm-pass" class="form-control form-control-lg" placeholder="Confirm Password" required="" autofocus="">
    </div>
