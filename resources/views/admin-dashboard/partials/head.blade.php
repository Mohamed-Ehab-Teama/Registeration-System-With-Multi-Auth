<head>
    ...
    <link rel="icon" href="{{ asset('dashboard-assets') }}/assets/images/logo.svg">
    ...
    <!-- Simple bar CSS -->
    <link rel="stylesheet" href="{{ asset('dashboard-assets') }}/css/simplebar.css">
    <!-- Fonts CSS -->
    ...
    <link rel="stylesheet" href="{{ asset('dashboard-assets') }}/css/app-dark.css" id="darkTheme" disabled>
</head>